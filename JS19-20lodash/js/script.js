...
//Array skills
var dataSkills =_.union(_.flatten(_.map(obj, 'skills'))).sort();//возвращает отсортированный с порядком в Unicode массив 
console.log(dataSkills);
//Array name
var dataName = _.map(_.sortBy(obj, function (obj){return obj.friends.length;}), 'name');//Возвращает массив сортированных по возрастанию элементов коллекции. Для сортировки используются значения получаемые функцией обратного вызова по каждому элементу.
console.log(dataName);
//Array friends	
var dataFriends = _.union(_.map(_.flatten(_.map(obj,'friends')),'name')).sort()
